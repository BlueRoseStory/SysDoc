...
export class BookService {
  // TODO Add this to Store and pull it from there.
  private booksUrl = 'https://fn-sysdoc.azurewebsites.net/api/books' +
  '?code=FoxHQj5GrixN0n0YKNab1MZkjbfVHEssAmEcUALLYBxaaho2H8AisA==&clientId=default';
